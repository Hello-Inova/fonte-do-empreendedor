...
const state={events:[],partners:[],profile:null,logoData:null,year:today.getFullYear(),month:today.getMonth(),registrations:[],registrationQuery:'',registrationEvent:'',eventFolderEnabled:true,eventAlertEnabled:true};
